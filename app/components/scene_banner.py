...
class SceneBanner:
    ...
    def _build(self) -> ft.Control:
        self._text = ft.Text("📍 Scene Change", size=TEXT_SM, weight=ft.FontWeight.W_700, color=ft.Colors.PRIMARY)
    ...
    def show(self, scene: dict):
        ...
        label = "📍 Scene Change" if not manual else "📍 Scene Updated"
        if scene.get("is_time_gen"):
            label = "📍 Generated by real time"
